          ...
          Center(
            child: Column(
              children: [
                ...
                Text(student.studentId, style: Theme.of(context).textTheme.bodyMedium),
              ],
            ),
          ),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                _InfoTile(icon: Icons.account_balance_outlined, label: 'Department', value: student.department),
                const Divider(height: 1),
                _InfoTile(icon: Icons.apartment_rounded, label: 'Faculty', value: student.faculty),
              ],
            ),
          ),
          const SizedBox(height: AppSpacing.lg),
